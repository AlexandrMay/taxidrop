Feature: passenger_registration
  ...
  Scenario: passenger/registration
    ...
    Scenario Outline: passenger/registration with errors
      ...
      |"false"|"Auto"  |"Passenger"|"+380639348839"|"buggserazzer@hotmail.com"|"passengerpass"|""  |"L5F4i7dryng8Bc!Gf6JV"|/passenger/registration|412|error.message|Incorrect request headers. Headers: 'Key' are malformed or incorrect.|
      |"true"|""  |"Passenger"|"+380639348839"|"buggserazzer@hotmail.com"|"passengerpass"|""  |"L5F4i7dryng8Bc!Gf6JV"|/passenger/registration|400|error.message|Incorrect request body. Parameters: 'first_name' are required.|
      |"true"|"Auto"  |""|"+380639348839"|"buggserazzer@hotmail.com"|"passengerpass"|""  |"L5F4i7dryng8Bc!Gf6JV"|/passenger/registration|400|error.message|Incorrect request body. Parameters: 'last_name' are required.|
      ...
      |"true"|"Auto"  |"Passenger"|"+380639348839"|""|"passengerpass"|""  |"L5F4i7dryng8Bc!Gf6JV"|/passenger/registration|400|error.message|Incorrect request body. Parameters: 'email' are required.|
      |"true"|"Auto"  |"Passenger"|"+380639348839"|"buggserazzer@hotmail.com"|"123"|""  |"L5F4i7dryng8Bc!Gf6JV"|/passenger/registration|400|error.message|Incorrect request body. Parameters: 'password' are malformed or incorrect.|
      |"true"|"Auto"  |"Passenger"|"+380639348839"|"buggserazzer@hotmail.com"|""|""  |"L5F4i7dryng8Bc!Gf6JV"|/passenger/registration|400|error.message|Incorrect request body. Parameters: 'password' are required.|
      |"true"|"Auto"  |"Passenger"|"+380639348839"|"buggserazzer@hotmail.com"|"passengerpass"|"123456789123456789123"|"L5F4i7dryng8Bc!Gf6JV"|/passenger/registration|400|error.message|Incorrect request body. Parameters: 'invite_code' are malformed or incorrect.|
      |"true"|"Auto"  |"Passenger"|"+380639348839"|"buggserazzer@hotmail.com"|"passengerpass"|""|"L5F4i7dryng8Bc!Gf6JV"|/passenger/registration|400|error.message|Registration token is incorrect.|
      |"true"|"Auto"  |"Passenger"|"+380639348839"|"buggserazzer@hotmail.com"|"passengerpass"|""|""|/passenger/registration|400|error.message|Registration token is incorrect.|
